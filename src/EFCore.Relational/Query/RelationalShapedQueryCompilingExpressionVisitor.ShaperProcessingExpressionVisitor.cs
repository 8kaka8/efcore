...
namespace Microsoft.EntityFrameworkCore.Query
{
    public partial class RelationalShapedQueryCompilingExpressionVisitor
    {
        private sealed class ShaperProcessingExpressionVisitor : ExpressionVisitor
        {
            ...
            private readonly IDictionary<ParameterExpression, int> _discriminatorExpressionsOffset
            ...
            protected override Expression VisitBinary(BinaryExpression binaryExpression)
            {
                    ...
                    && parameterExpression.Type == typeof(MaterializationContext))
                {
                    ...
                    _discriminatorExpressionsOffset[parameterExpression] = propertyMap.Values.Max() + 1;
            ...
            protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
            {
                    ...
                    && methodCallExpression.Method.GetGenericMethodDefinition() == Infrastructure.ExpressionExtensions.ValueBufferTryReadValueMethod)
                {
                    ...
                    var projectionIndex = property == null
                        ? _discriminatorExpressionsOffset[mappingParameter] + (int)((ConstantExpression)methodCallExpression.Arguments[1]).Value
